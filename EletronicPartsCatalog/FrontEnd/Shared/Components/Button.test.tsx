...
describe('Button component', () => {
    ...
    it('should be possible to set href in link mode', () => {
        const wrapper = shallow(<Button link={true} href={'www.github.com'} />);
        expect(wrapper.find('[href="www.github.com"]')).toHaveLength(1);
    });
    ...
    it('should omit href if passed in button mode', () => {
        const wrapper = shallow(<Button link={false} href={'www.github.com'} />);
